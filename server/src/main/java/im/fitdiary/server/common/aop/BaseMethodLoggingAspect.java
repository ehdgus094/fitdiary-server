package im.fitdiary.server.common.aop;
...
public class BaseMethodLoggingAspect {
    ...
    @Pointcut("@annotation(im.fitdiary.server.common.aop.annotation.BaseMethodLogging)")
    private void methodPointcut() {}

    @Pointcut("@within(im.fitdiary.server.common.aop.annotation.BaseMethodLogging)")
